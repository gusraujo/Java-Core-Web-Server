...
public class MultiThreadOptimize {
    ...
    public static void recolorMultiThreaded(BufferedImage original, BufferedImage resultImage, int numberOfThreads) throws InterruptedException {
        ...
        for (int i = 0; i < numberOfThreads; i++){
            ...
            Thread thread = new Thread(() -> {
                ...
                recolorImage(original, resultImage, leftCorner, topCorner, width, height);
            });
            threads.add(thread);
        }
